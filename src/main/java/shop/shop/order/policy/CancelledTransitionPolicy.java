...
/**
 * class  định nghĩa rule chuyển đổi trạng thái của Order ở trang thái cancel.
...
@Component
public class CancelledTransitionPolicy implements IOrderStatusTransitionPolicy  {
