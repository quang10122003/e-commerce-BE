/**
 * class  định nghĩa rule chuyển đổi trạng thái của Order ở trang thái COMPLETED.
...
@Component
public class CompletedTransitionPolicy implements IOrderStatusTransitionPolicy {
